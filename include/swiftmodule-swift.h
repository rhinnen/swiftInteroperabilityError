// Generated by Swift version 5.10 (swift-5.10-RELEASE)
#ifndef SWIFTMODULE_SWIFT_H
#define SWIFTMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("SwiftModule", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace SwiftModule SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("SwiftModule") {
namespace _impl {
extern "C" {
#endif

// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_passStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK struct swift_interop_passStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 swift_interop_passDirect_SwiftModule_uint64_t_0_8_void_ptr_8_16(const char * _Nonnull value) {
  struct swift_interop_passStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 result;
  memcpy(&result._1, value + 0, 8);
  memcpy(&result._2, value + 8, 8);
  return result;
}

SWIFT_EXTERN void * _Nonnull $s11SwiftModule0A2ItC2itACSS_tcfC(struct swift_interop_passStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 it, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init(it:)
// Stub struct to be used to pass/return values to/from Swift functions.
struct swift_interop_returnStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 {
  uint64_t _1;
  void * _Nullable _2;
};

static SWIFT_C_INLINE_THUNK void swift_interop_returnDirect_SwiftModule_uint64_t_0_8_void_ptr_8_16(char * _Nonnull result, struct swift_interop_returnStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 value) {
  memcpy(result + 0, &value._1, 8);
  memcpy(result + 8, &value._2, 8);
}

SWIFT_EXTERN struct swift_interop_returnStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 $s11SwiftModule0A2ItC2itSSvg(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s11SwiftModule0A2ItC2itSSvs(struct swift_interop_passStub_SwiftModule_uint64_t_0_8_void_ptr_8_16 value, SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
SWIFT_EXTERN void $s11SwiftModule0A2ItC05printA0yyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // printSwift()
...
class SWIFT_SYMBOL("s:11SwiftModule0A2ItC") SwiftIt;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SwiftModule::SwiftIt> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SwiftIt;
// Type metadata accessor for SwiftIt
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11SwiftModule0A2ItCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:11SwiftModule0A2ItC") SwiftIt : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK SwiftIt init(const swift::String& it) SWIFT_SYMBOL("s:11SwiftModule0A2ItC2itACSS_tcfc");
  SWIFT_INLINE_THUNK swift::String getIt() SWIFT_SYMBOL("s:11SwiftModule0A2ItC2itSSvp");
  SWIFT_INLINE_THUNK void setIt(const swift::String& value) SWIFT_SYMBOL("s:11SwiftModule0A2ItC2itSSvp");
  SWIFT_INLINE_THUNK void printSwift() SWIFT_SYMBOL("s:11SwiftModule0A2ItC05printA0yyF");
protected:
  SWIFT_INLINE_THUNK SwiftIt(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_SwiftIt;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11SwiftModule0A2ItCD;
  static inline constexpr $s11SwiftModule0A2ItCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SwiftIt {
public:
static SWIFT_INLINE_THUNK SwiftIt makeRetained(void * _Nonnull ptr) noexcept { return SwiftIt(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SwiftModule::SwiftIt> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return SwiftModule::_impl::$s11SwiftModule0A2ItCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<SwiftModule::SwiftIt> { using type = SwiftModule::_impl::_impl_SwiftIt; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace SwiftModule SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("SwiftModule") {
  ...
  SWIFT_INLINE_THUNK SwiftIt SwiftIt::init(const swift::String& it) {
  alignas(alignof(swift::String)) char copyBuffer_consumedParamCopy_it[sizeof(swift::String)];
  auto &consumedParamCopy_it = *(new(copyBuffer_consumedParamCopy_it) swift::String(it));
  swift::_impl::ConsumedValueStorageDestroyer<swift::String> storageGuard_consumedParamCopy_it(consumedParamCopy_it);
  return _impl::_impl_SwiftIt::makeRetained(_impl::$s11SwiftModule0A2ItC2itACSS_tcfC(_impl::swift_interop_passDirect_SwiftModule_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_it)), swift::TypeMetadataTrait<SwiftIt>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK swift::String SwiftIt::getIt() {
...
#endif
struct FTypeAddress {
decltype(_impl::$s11SwiftModule0A2ItC2itSSvg) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 80 / sizeof(void *));
  return swift::_impl::_impl_String::returnNewValue([&](char * _Nonnull result) SWIFT_INLINE_THUNK_ATTRIBUTES {
    _impl::swift_interop_returnDirect_SwiftModule_uint64_t_0_8_void_ptr_8_16(result, (* fptrptr_->func)(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this)));
  });
  }
  SWIFT_INLINE_THUNK void SwiftIt::setIt(const swift::String& value) {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s11SwiftModule0A2ItC2itSSvs) * func;
};
FTypeAddress *fptrptr_ = reinterpret_cast<FTypeAddress *>(vtable_ + 88 / sizeof(void *));
  ...
  return (* fptrptr_->func)(_impl::swift_interop_passDirect_SwiftModule_uint64_t_0_8_void_ptr_8_16(swift::_impl::_impl_String::getOpaquePointer(consumedParamCopy_value)), ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void SwiftIt::printSwift() {
void ***selfPtr_ = reinterpret_cast<void ***>( ::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
#ifdef __arm64e__
void **vtable_ = ptrauth_auth_data(*selfPtr_, ptrauth_key_process_independent_data, ptrauth_blend_discriminator(selfPtr_,27361));
#else
...
#endif
struct FTypeAddress {
decltype(_impl::$s11SwiftModule0A2ItC05printA0yyF) * func;
};
